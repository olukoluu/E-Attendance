<aside class="side_nav position-sticky start-0 top-0 py-2 pt-4 text-center d-md-flex flex-column align-items-center border" style="height: 100vh; width: fit-content">
            <a href="#" class="logo">
            ...
            <ul class="nav flex-column mt-4 h-100">
                ...
                <li class="nav-item">
                    <a href="lecturer.php" class="nav-link"><img src="template/images/classes.png" alt="profile" style="width: 25px; padding-top: 20px;" />
                        <p>Lecturers</p>

                    </a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link"><img src="template/images/report.png" alt="report" style="width: 25px; padding-top: 20px;" />
                        <p>Sign out</p>
                    </a>
                </li>
